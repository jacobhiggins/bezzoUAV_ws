...
params.kp_roll = 1*3.24*Ixx/t_attitude^2;
params.kd_roll = 1*3.6*xi_attitude*Ixx/t_attitude;

params.kp_pitch = 1*3.24*Iyy/t_attitude^2;
params.kd_pitch = 1*3.6*xi_attitude*Ixx/t_attitude;
