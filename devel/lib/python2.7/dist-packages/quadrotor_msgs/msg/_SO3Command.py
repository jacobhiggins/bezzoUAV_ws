...
class SO3Command(genpy.Message):
  _md5sum = "7b780532c172bc596487296e01a1077e"
...
"""
  __slots__ = ['header','force','orientation','angular','kR','kOm','aux']
  _slot_types = ['std_msgs/Header','geometry_msgs/Vector3','geometry_msgs/Quaternion','geometry_msgs/Vector3','float64[3]','float64[3]','quadrotor_msgs/AuxCommand']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,force,orientation,angular,kR,kOm,aux
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_10d().pack(_x.force.x, _x.force.y, _x.force.z, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w, _x.angular.x, _x.angular.y, _x.angular.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.force.x, _x.force.y, _x.force.z, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w, _x.angular.x, _x.angular.y, _x.angular.z,) = _get_struct_10d().unpack(str[start:end])
      start = end
      end += 24
