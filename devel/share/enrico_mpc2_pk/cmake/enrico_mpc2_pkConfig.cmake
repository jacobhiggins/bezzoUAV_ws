...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'enrico_mpc2_pk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bezzo/bezzoUAV_ws/src/quadrotor_sim/enrico_mpc2_pk/${idir}'.  ${_report}")
    endif()
