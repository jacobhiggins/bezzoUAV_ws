...
if("TRUE" STREQUAL "TRUE")
  set(enrico_mpc2_pk_SOURCE_PREFIX /home/bini/versioned/uav_ros/src/quadrotor_sim/enrico_mpc2_pk)
  set(enrico_mpc2_pk_DEVEL_PREFIX /home/bini/versioned/uav_ros/devel)
  ...
  set(enrico_mpc2_pk_INSTALL_PREFIX /home/bini/versioned/uav_ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'enrico_mpc2_pk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bini/versioned/uav_ros/src/quadrotor_sim/enrico_mpc2_pk/${idir}'.  ${_report}")
    endif()
